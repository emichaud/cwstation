...
| [logging-audit.md](logging-audit.md) | Logging configuration, audit trail, and **reading logs from a deployment you can't shell into** — JSON output with `request_id` correlation, DB-backed capture, time-boxed `log_capture` windows |
